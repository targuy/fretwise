"""Build the chord fingering dataset (standard dictionary + optional scrape).

Thin wrapper around ``fretwise.dataset.pipeline.build_chord_dataset``.
...
from fretwise.dataset.pipeline.build_chord_dataset import main
