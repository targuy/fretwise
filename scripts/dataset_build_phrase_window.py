"""Build the phrase-window training dataset (74-dim feature rows).

Thin wrapper around ``fretwise.dataset.pipeline.build_phrase_window_dataset``.
...
from fretwise.dataset.pipeline.build_phrase_window_dataset import main
