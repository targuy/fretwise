"""Cross-validate fingering quality across all chord data sources.

Thin wrapper around ``fretwise.dataset.pipeline.validate_fingering_quality``.
...
from fretwise.dataset.pipeline.validate_fingering_quality import main
