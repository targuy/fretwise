"""Train the transition-cost v3 XGBoost model.

Thin wrapper around ``fretwise.dataset.pipeline.train_transition_cost_v3``.
...
from fretwise.dataset.pipeline.train_transition_cost_v3 import main
